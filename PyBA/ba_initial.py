...
points_p = project(points_3d[point_indices], camera_params[camera_indices])
...
camera_params_optimized = res.x[:n_cameras * 9].reshape((n_cameras, 9))
points_3d_optimized = res.x[n_cameras * 9:].reshape((n_points, 3))

points_p = project(points_3d_optimized[point_indices], camera_params_optimized[camera_indices])
...
plt.plot(camera_params[:, 6], 'bo', markersize=2)
plt.plot(camera_params_optimized[:, 6], 'ro', markersize=2)
plt.show()
