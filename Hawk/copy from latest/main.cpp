...
int _shutterSpeed = 36;
int _analogGain = 1;

int contModeLastSendTimeUs = 0;

int frameWidth = IMG_WIDTH;
int frameHeight = IMG_HEIGHT;
int frameStride = 0;
...
ldiCameraCaptureMode _mode = CCM_CONTINUOUS;
...
int main() {
	...
	if (cameraStart(camContext, frameWidth, frameHeight, 3, _shutterSpeed, _analogGain, &frameSize, &frameStride) != 0) {
