...
# Source mesh.
print("Reading mesh: {}".format(sys.argv[1]))
...
# Scan point cloud.
print("Reading scan: {}".format(sys.argv[2]))
scan_pcl = o3d.io.read_point_cloud(sys.argv[2])
...
o3d.io.write_triangle_mesh(sys.argv[3], mesh)
